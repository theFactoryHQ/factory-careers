...
* **applications:** enforce public job closing dates, create submission records atomically, and associate uploaded documents with the application that received them
