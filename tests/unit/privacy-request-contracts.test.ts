...
describe('privacy request source contracts', () => {
  ...
  it('adds the public intake and verification surfaces', () => {
    ...
    expect(deleteRequestPage).toContain('<FactorySelect')
    expect(deleteRequestPage).toContain('class="factory-public-form')
    expect(deleteRequestPage).not.toContain('<select')
