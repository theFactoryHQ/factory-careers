...
useSeoMeta({
  ...
  description: 'Create a reusable candidate email template',
...
<template>
  <div class="mx-auto max-w-5xl px-6 py-8">
      ...
      <div class="flex items-start gap-3">
        ...
        <div>
          ...
          <p class="text-sm text-surface-500 dark:text-surface-400 mt-0.5">
            Create a reusable email template for candidate workflow emails.
          </p>
        </div>
      </div>
    ...
    <!-- Error -->
    <div v-if="validationError" class="ui-alert-danger mb-6 flex items-start gap-2.5 rounded-xl p-4 text-sm">
    ...
    <div class="grid gap-6" :class="showPreview ? 'lg:grid-cols-2' : 'lg:grid-cols-[1fr_320px]'">
      ...
      <div class="space-y-5">
        ...
        <div class="ui-panel p-5">
          <label for="template-purpose" class="block text-xs font-semibold uppercase tracking-wider text-surface-500 dark:text-surface-400 mb-2">
            Workflow
          </label>
          <select
            id="template-purpose"
